...
- **Add Contribution Page** contains a form to provide a contribution to a book. The user end the book registration by clicking on the Save button, which redirects user on the Latest Book Page ![Book Add Contribution](./docs/features/features_book_add_contribution.png)
