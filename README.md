...
- **Book Page for authorized user** shows only basic book information and the user who added the book. In addition, there are two buttons to edit or delete the book. ![Basic Book Detail](./docs/features/features_book_detail.png) 
